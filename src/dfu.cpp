...
static uint8_t usbdfu_getstatus(uint32_t *bwPollTimeout)
{
    switch (usbdfu_state)
    {
        ...
        case STATE_DFU_MANIFEST_SYNC:
            ...
            return DFU_STATUS_OK;
        case STATE_DFU_ERROR: return STATE_DFU_ERROR;
        default: return DFU_STATUS_OK;
    }
}
...
static void usbdfu_getstatus_complete(struct usb_setup_data *req)
{
    ...
    switch (usbdfu_state)
    {
        case STATE_DFU_DNBUSY:
            ...
            return;
        case STATE_DFU_MANIFEST: return; // Reset placed in main loop.
        default: return;
    }
}
                                                      ...
                                                      void (**complete)(struct usb_setup_data *req))
{
    switch (req->bRequest)
    {
        ...
        case DFU_ABORT:
            ...
            usbdfu_state = STATE_DFU_IDLE;
            return USBD_REQ_HANDLED;
        case DFU_DETACH: usbdfu_state = STATE_DFU_MANIFEST; return USBD_REQ_HANDLED;
        case DFU_UPLOAD:
